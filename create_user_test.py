...
# Функция для негативной проверки. В ответе ошибка: "Не все необходимые параметры были переданы"
...
# Тест 4. Ошибка. Параметр fisrtName состоит из 16 символа
...
# Тест 7. Ошибка. Параметр fisrtName состоит из слов с пробелами
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и КО")


# Тест 8. Ошибка. Параметр fisrtName состоит из строки спецсимволов
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("№%@")


# Тест 9. Ошибка. Параметр fisrtName состоит из строки с цифрами
